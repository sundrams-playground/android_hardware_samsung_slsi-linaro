...
#define TSMUX_IOCTL_ASB_TEST _IOW('A', 0x30, struct tsmux_asb_job)
#define TSMUX_IOCTL_ENABLE_OTF_DUMMY_TS_PACKET _IO('A', 0x40)
#define TSMUX_IOCTL_DISABLE_OTF_DUMMY_TS_PACKET _IO('A', 0x41)
#endif

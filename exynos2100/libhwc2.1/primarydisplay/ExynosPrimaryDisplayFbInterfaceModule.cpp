...
decon_idma_type ExynosPrimaryDisplayFbInterfaceModule::getSubDeconDMAType(decon_idma_type channel)
{
    return getSubDeconChannel(channel);
}

int32_t ExynosPrimaryDisplayFbInterfaceModule::preProcessForVirtual8K(struct decon_win_config* savedVirtualWinConfig)
{
    return remakeConfigForVirtual8K(savedVirtualWinConfig, &mFbConfigData);
}

int32_t ExynosPrimaryDisplayFbInterfaceModule::postProcessForVirtual8K(struct decon_win_config savedVirtualWinConfig)
{

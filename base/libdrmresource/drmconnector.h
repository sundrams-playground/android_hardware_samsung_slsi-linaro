...
class DrmConnector {
 public:
  ...
  const DrmProperty &writeback_use_repeater_buffer() const;
  const DrmProperty &writeback_standard() const;
  const DrmProperty &writeback_range() const;
 ...
 private:
  ...
  DrmProperty writeback_use_repeater_buffer_;
  DrmProperty writeback_standard_;
  DrmProperty writeback_range_;
  DrmProperty max_luminance_;
  DrmProperty max_avg_luminance_;
  DrmProperty min_luminance_;
  DrmProperty hdr_formats_;
  DrmProperty adjusted_fps_;
  ...
  int UpdateProperty(DrmProperty *property);
};
}  // namespace android

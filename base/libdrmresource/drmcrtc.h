...
class DrmCrtc {
 public:
  ...
  DrmProperty &operation_mode_property();
  DrmProperty &dsr_status_property();
  DrmProperty &color_mode_property();
  DrmProperty &dqe_fd_property();
  DrmProperty &render_intent_property();
  DrmProperty &modeset_only_property();
  const DrmProperty &bts_fps_property() const;
 ...
 private:
  ...
  DrmProperty operation_mode_property_;
  DrmProperty dsr_status_property_;
  DrmProperty color_mode_property_;
  DrmProperty dqe_fd_property_;
  DrmProperty render_intent_property_;
  DrmProperty modeset_only_property_;
  DrmProperty bts_fps_property_;

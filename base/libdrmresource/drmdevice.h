...
class DrmDevice {
 public:
  ...
  int UpdateConnectorProperty(const DrmConnector &connector, DrmProperty *property);
  ...
  void RegisterPanelResetHandler(DrmEventHandler *handler) {
    event_listener_.RegisterPanelResetHandler(handler);
  }
 ...
 private:
  ...
  int AttachWriteback(int display);

...
class DrmEventHandler {
 public:
  ...
  virtual void HandlePanelEvent(uint64_t timestamp_us) = 0;
};
...
class DrmEventListener : public Worker {
 public:
  ...
  void RegisterPanelResetHandler(DrmEventHandler *handler);
  void UnRegisterPanelResetHandler(DrmEventHandler *handler);
 ...
 private:
  ...
  std::unique_ptr<DrmEventHandler> panelreset_handler_;
};
}  // namespace android

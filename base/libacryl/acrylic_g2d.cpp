                                      ...
                                      uint32_t target_width, uint32_t target_height)
{
    ...
    if ((layer.getCompositingMode() == HWC_BLENDING_PREMULT) ||
        ...
        if (image.fmt.pixelformat == V4L2_PIX_FMT_ARGB32) {
            image.fmt.pixelformat = V4L2_PIX_FMT_XRGB32;
        } else if (image.fmt.pixelformat == V4L2_PIX_FMT_ABGR32) {
            image.fmt.pixelformat = V4L2_PIX_FMT_XBGR32;
        }
    }

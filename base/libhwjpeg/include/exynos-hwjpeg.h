...
public:
     ...
     *          false, otherwise.
     */
    virtual bool SetQuality(const unsigned char __unused qtable[]) = 0;
    /*
     ...
     *                    false, otherwise.
     */
    virtual bool SetImageBuffer2(char __unused *buffers[], size_t __unused len_buffers[], unsigned int __unused num_buffers) = 0;
    /*
     ...
     *                    false, otherwise.
     */
    virtual bool SetImageBuffer2(int __unused buffers[], size_t __unused len_buffers[], unsigned int __unused num_buffers) = 0;
    /*
     ...
     */
    virtual bool SetJpegBuffer2(char __unused *buffer, size_t __unused len_buffer) = 0;
    /*
     ...
     * is not configured with SetImageSize().
     */
    virtual bool SetJpegBuffer2(int __unused buffer, size_t __unused len_buffer) = 0;
    /*
     ...
     * Compress().
     */
    virtual ssize_t WaitForCompression(size_t __unused *secondary_stream_size = NULL) = 0;
    /*
     ...
     */
    virtual bool GetImageBuffers(int __unused buffers[], size_t __unused len_buffers[], unsigned int __unused num_buffers) = 0;
    /*
     ...
     * This function is just provided to support the legacy ExynosJpegEncoder API.
     */
    virtual bool GetImageBuffers(char __unused *buffers[], size_t __unused len_buffers[], unsigned int __unused num_buffers) = 0;
    /*
     ...
     * This function is just provided to support the legacy ExynosJpegEncoder API.
     */
    virtual bool GetJpegBuffer(int __unused *buffers, size_t __unused *len_buffer) = 0;
    /*
     ...
     * This function is just provided to support the legacy ExynosJpegEncoder API.
     */
    virtual bool GetJpegBuffer(char __unused **buffers, size_t __unused *len_buffer) = 0;
    /*
     * Release - release the buffers acquired by CHWJpegCompressor
     */
    virtual void Release() = 0;

    virtual void DumpInfo(bool __unused thumb, bool __unused btb) = 0;
};
...
public:
    ...
    virtual void DumpInfo(bool thumb, bool btb);
};
